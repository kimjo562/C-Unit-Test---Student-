...
namespace MathClasses
{
    public class Matrix3
    {
        ...
        {
            return new Vector3(
                (lhs.m1x1 * rhs.x) + (lhs.m2x1 * rhs.y) + (lhs.m3x1 * rhs.z),   // X Vector
                (lhs.m1x2 * rhs.x) + (lhs.m2x2 * rhs.y) + (lhs.m3x2 * rhs.z),   // Y Vector
                (lhs.m1x3 * rhs.x) + (lhs.m2x3 * rhs.y) + (lhs.m3x3 * rhs.z));  // Z Vector
        }
