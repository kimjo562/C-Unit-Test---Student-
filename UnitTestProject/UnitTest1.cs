...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        {
            if (Math.Abs(a.m1x1 - b.m1x1) > tolerance || Math.Abs(a.m1x2 - b.m1x2) > tolerance || Math.Abs(a.m1x3 - b.m1x3) > tolerance || Math.Abs(a.m1x4 - b.m1x4) > tolerance ||
                Math.Abs(a.m2x1 - b.m2x1) > tolerance || Math.Abs(a.m2x2 - b.m2x2) > tolerance || Math.Abs(a.m2x3 - b.m2x3) > tolerance || Math.Abs(a.m2x4 - b.m2x4) > tolerance ||
                Math.Abs(a.m3x1 - b.m3x1) > tolerance || Math.Abs(a.m3x2 - b.m3x2) > tolerance || Math.Abs(a.m3x3 - b.m3x3) > tolerance || Math.Abs(a.m3x4 - b.m3x4) > tolerance ||
                Math.Abs(a.m4x1 - b.m4x1) > tolerance || Math.Abs(a.m4x2 - b.m4x2) > tolerance || Math.Abs(a.m4x3 - b.m4x3) > tolerance || Math.Abs(a.m4x4 - b.m4x4) > tolerance)
                return false;
            return true;
        }
        ...
        public void Vector3MatrixTranslation2()
        {
            ...
            Matrix3 m3c = new Matrix3();
            m3c.SetRotateZ(2.2f);
            m3c.m3x1 = 55; m3c.m3x2 = 44; m3c.m3x3 = 1;
        ...
        public void Vector4MatrixTranslation2()
        {
            ...
            Matrix4 m4c = new Matrix4();
            m4c.SetRotateZ(2.2f);
            m4c.m4x1 = 55; m4c.m4x2 = 44; m4c.m4x3 = 99; m4c.m4x4 = 1;
